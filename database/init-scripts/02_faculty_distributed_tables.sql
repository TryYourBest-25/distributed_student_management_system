...
ALTER TABLE class
    ADD CONSTRAINT fk_class_faculty FOREIGN KEY (faculty_code) REFERENCES faculty(faculty_code);
ALTER TABLE class
    ADD CONSTRAINT fk_class_global_code FOREIGN KEY (class_code, class_name) REFERENCES global_class_code(class_code, class_name);
...
ALTER TABLE student
    ADD CONSTRAINT fk_student_global_code FOREIGN KEY (student_code) REFERENCES global_student_code(student_code);
...
ALTER TABLE credit_class
    ADD CONSTRAINT fk_credit_class_course FOREIGN KEY (course_code) REFERENCES course(course_code);
ALTER TABLE credit_class
    ADD CONSTRAINT fk_credit_class_lecturer FOREIGN KEY (lecturer_code) REFERENCES lecturer(lecturer_code);
ALTER TABLE credit_class
    ADD CONSTRAINT fk_credit_class_faculty FOREIGN KEY (faculty_code) REFERENCES faculty(faculty_code);
ALTER TABLE credit_class
